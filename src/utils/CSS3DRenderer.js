...
const CSS3DRenderer = function () {
  ...
  function getCameraCSSMatrix(matrix) {
    ...
    return `matrix3d(${epsilon(elements[0])},${epsilon(-elements[1])},${epsilon(
      elements[2],
    )},${epsilon(elements[3])},${epsilon(elements[4])},${epsilon(-elements[5])},${epsilon(
      elements[6],
    )},${epsilon(elements[7])},${epsilon(elements[8])},${epsilon(-elements[9])},${epsilon(
      elements[10],
  ...
  function getObjectCSSMatrix(matrix, cameraCSSMatrix) {
    const { elements } = matrix;
    const matrix3d = `matrix3d(${epsilon(elements[0])},${epsilon(elements[1])},${epsilon(
      elements[2],
    ...
    if (isIE) {
      ...
      }${_widthHalf}px,${_heightHalf}px)${cameraCSSMatrix}${matrix3d}`;
    }
  ...
  this.render = function (scene, camera) {
    ...
    const cameraCSSMatrix = camera.isOrthographicCamera
      ? `scale(${fov})` +
        `translate(${epsilon(tx)}px,${epsilon(ty)}px)${getCameraCSSMatrix(
